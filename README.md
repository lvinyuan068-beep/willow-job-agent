...
独立使用 **Codex/claude code** 辅助开发的 AI 原生工具，围绕岗位筛选、简历定制、面试准备中的重复决策问题，形成「岗位判断→证据校验→定向简历→面试执行→投递留档」求职闭环。
...
- **V0.1** → 初期原型
- **V1.0** → 核心链路跑通
- **V2.0（当前）** → 新增求职补助包 + Application Tracker
- **V3.0 规划（待 7/23 算力刷新后）** → 接入写作 Skills 优化文本质量 + 重构 UI/UX 游戏化交互
...
- **开发方式：** codex/Claude Code 辅助，独立设计产品逻辑
